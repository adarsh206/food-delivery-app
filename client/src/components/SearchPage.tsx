      ...
      <div className="flex flex-col md:flex-row justify-between gap-10">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <Button className="bg-orange hover:bg-hoverColor">Search</Button>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[1, 2, 3].map((item: number, idx: number) => (
                <Card className="bg-white dark:bg-gray-800 shadow-xl rounded-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                  ...
                  <CardContent>
                    <h1
                      className="text-2xl top-0 font-bold dark:text-gray-100 
                    bg-gradient-to-r from-orange-500 via-green-500 to-pink-500 bg-clip-text text-transparent"
                    >
                      Pizza House
                    </h1>
                  ...
                  <CardFooter className="p-4 border-t dark:border-t-gray-100 text-white flex justify-end ">
                    <Link to={`/restaurant/${123}`}>
                      <Button className="bg-orange hover:bg-hoverColor font-semibold py-2 px-4 rounded-full shadow-md transition-colors duration-200 hover:shadow-[#fffcad] hover:shadow-lg">
                        View Menu
                      </Button>
                    </Link>
                  </CardFooter>
