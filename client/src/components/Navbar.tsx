  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="flex items-center justify-between h-14">
        <Link to="/">
          <h1
            className="font-bold md:font-extrabold text-2xl md:text-3xl
    ...
    <Sheet>
      ...
      <SheetContent className="flex flex-col">
        <SheetHeader className="flex flex-row items-center justify-between mt-5">
          <SheetTitle className="font-extrabold bg-gradient-to-r from-orange-600 via-green-600 to-pink-600 bg-clip-text text-transparent">
            FOODIE
          </SheetTitle>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
        ...
        <SheetDescription className="flex-1 mx-2">
        <Link
            to="/profile"
        ...
        <div className="flex flex-row items-center gap-2">
            ...
            <h1 className="font-bold bg-gradient-to-r from-orange-600 via-green-600 to-pink-600 bg-clip-text text-transparent">FOODIE</h1>
          </div>
        <SheetClose asChild>
            {loading ? (
              <Button className="bg-orange hover:bg-hoverColor">
