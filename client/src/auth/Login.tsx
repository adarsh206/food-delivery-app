  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <form className="md:p-8 w-full max-w-md md:border border-gray-200 rounded-lg mx-4">
        ...
        <div className="mb-10">
            {
                loading ? <Button className="w-full bg-orange hover:bg-hoverColor"><Loader2 className="mr-2 h-4 w-4 animate-spin"/>Please wait</Button> : (
                    <Button className="w-full bg-orange hover:bg-hoverColor">Login</Button>
                )
            }    
        </div>
        <Separator />
